...
f = np.genfromtxt("data.txt", delimiter=',',dtype=np.longdouble, usecols=1)
x = np.genfromtxt("data.txt", delimiter=',',dtype=np.longdouble, usecols=0)
